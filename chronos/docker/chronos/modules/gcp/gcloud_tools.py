...
import googleapiclient.discovery, os, json
...
class gcloud_tools:
    ...
    def __init__(self):
        ...
        if os.getenv("GCLOUD_DEFAULT_CREDENTIALS") != "False":
            print("(GCP) Default credential: %s" % _auth.default_credentials().__dict__)
            ...
            print("(GCP) SA credential: %s" % credentials.__dict__)
